...
/** * Handles Bluetooth / USB OTG Gamepad Input, Analog Dead-zones, and Button Remapping */class GamepadManager {
...
fun getCurrentInputMask(): Int = currentMask or touchMask
