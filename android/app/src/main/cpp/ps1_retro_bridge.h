...
JNIEXPORT void JNICALL Java_com_ps1_netplay_core_NativeCoreBridge_nativeSetAudioVolume(JNIEnv *env, jobject thiz, jfloat volume);
JNIEXPORT void JNICALL Java_com_ps1_netplay_core_NativeCoreBridge_nativeSetAudioMute(JNIEnv *env, jobject thiz, jboolean muted);
JNIEXPORT jint JNICALL Java_com_ps1_netplay_core_NativeCoreBridge_nativeReadAudio(JNIEnv *env, jobject thiz, jshortArray out_buffer, jint max_samples);
JNIEXPORT void JNICALL Java_com_ps1_netplay_core_NativeCoreBridge_nativeResetAudio(JNIEnv *env, jobject thiz);
